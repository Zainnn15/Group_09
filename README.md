...
This website will be created using HTML and CSS for front end. We also will be implementing React to display our application components. For the back-end we will be using Node Javascript and for the database we will be using MongoDB.
